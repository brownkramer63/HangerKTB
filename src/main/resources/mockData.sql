insert into profile(identity ,firstName,lastName,email,phoneNumber,password)
values(1,'kramer','brown','kramer.t.brown@gmail.com',2177413554,'Fish'),
      (2,'marissa', 'tatro', 'gyp@gmail.com',6668889999,'hhhh');

insert into services(identity ,serviceName,serviceDuration,servicePrice,serviceStartTime,serviceEndTime,serviceTimeRemaining,profile_id)
